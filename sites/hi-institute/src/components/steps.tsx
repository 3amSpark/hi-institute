...
function StepPanel({
  ...
  return (
    <div className="relative flex-1 overflow-hidden">
      ...
      >
        <h3 className="text-sm font-medium uppercase text-shadow-sm md:text-lg lg:text-xl">
      ...
      <div className="flex flex-col bg-white md:hidden">
        {steps.map((step) => (
          ...
          >
            ...
            >
              <h3 className="text-base font-medium tracking-[0.2em] uppercase text-shadow-sm">
                {step.number}. {step.title}
              </h3>
